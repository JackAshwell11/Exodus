...
void Engine::fixed_update(const float delta_time) const {
  run_systems<ecs::systems::input_system, ecs::systems::enemy_movement_system, ecs::systems::movement_system,
              ecs::systems::collision_resolution_system>(*registry_, *camera_, std::nullopt, delta_time);
}
